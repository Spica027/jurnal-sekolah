    ...
    <table border="1" style="border-collapse:collapse">
        ...
        <tbody>
            ...
            @forelse ($jurnal as $jurnals) <tr>
                ...
                <td style="font-size:10pt; padding:10px">{{$jurnals->materi}}</td>
                <td style="font-size:10pt;text-align:left; padding:10px">
                ...
                <td style="font-size:10pt">
                    <table frame="void"
                        ...
                        <tr>
                            <td style="font-size:8pt;text-align:left;border-right:1px solid black;padding:4px">
                            ...
                            <td style="font-size:8pt;border-bottom:1px solid black;text-align:center;font-weight:bold">
                                {{substr($jurnalx->pivot->keterangan,0,1)}}
                            </td>
                        </tr>
                        @empty
                        <div class="nihil" style="text-align: center;color:green">
                            -
                        </div>
                        @endforelse
                    </table>
